import{_ as t}from"./plugin-vue_export-helper-c27b6911.js";import{r as l,o as i,c,a as n,b as s,d as e,e as o}from"./app-0cc6753e.js";const p={},r=o('<div style="text-align:center;"><p>格机代码一览</p></div><h3 id="这里是哪" tabindex="-1"><a class="header-anchor" href="#这里是哪" aria-hidden="true">#</a> 这里是哪？</h3><p>这里是记录格机代码的地方</p><h3 id="为什么要记录格机代码" tabindex="-1"><a class="header-anchor" href="#为什么要记录格机代码" aria-hidden="true">#</a> 为什么要记录格机代码？</h3>',4),d={href:"https://yosunair.github.io/Yosunair-Flash-Home/",target:"_blank",rel:"noopener noreferrer"},m={id:"这是已经非常令人气愤的事情-我已经在很多格机脚本上看到了我的示例指令-有些甚至都是二传连指令都复制错了-而我的github-repo连一个star都没有-为此我重新开放了原来的flash-sukax-eu-org域名-并且更新了相关信息-希望一些人能够好自为之",tabindex:"-1"},v=n("a",{class:"header-anchor",href:"#这是已经非常令人气愤的事情-我已经在很多格机脚本上看到了我的示例指令-有些甚至都是二传连指令都复制错了-而我的github-repo连一个star都没有-为此我重新开放了原来的flash-sukax-eu-org域名-并且更新了相关信息-希望一些人能够好自为之","aria-hidden":"true"},"#",-1),b={href:"https://github.com/Yosunair/Yosunair-Flash-Home",target:"_blank",rel:"noopener noreferrer"},k={href:"http://flash.sukax.eu.org",target:"_blank",rel:"noopener noreferrer"},u=o('<h4 id="无论你是拿来写格机脚本还是拿来做科普-我都希望你能够留下我的名字-最起码能让我心里好受一点" tabindex="-1"><a class="header-anchor" href="#无论你是拿来写格机脚本还是拿来做科普-我都希望你能够留下我的名字-最起码能让我心里好受一点" aria-hidden="true">#</a> 无论你是拿来写格机脚本还是拿来做科普，我都希望你能够留下我的名字，最起码能让我心里好受一点</h4><h3 id="相关知识" tabindex="-1"><a class="header-anchor" href="#相关知识" aria-hidden="true">#</a> 相关知识</h3><h4 id="什么是格机" tabindex="-1"><a class="header-anchor" href="#什么是格机" aria-hidden="true">#</a> 什么是格机？</h4><p>格机指的是对 Android(Linux) 设备的系统进行不同程度的破坏，较轻的丢失手机数据，严重的则会导致设备损坏，需要进行较为底层的刷机(例如9008)，有些甚至需要拆机短接或者直接更换主板</p><h4 id="为什么会有格机" tabindex="-1"><a class="header-anchor" href="#为什么会有格机" aria-hidden="true">#</a> 为什么会有格机？</h4><p>Magisk/KernelSU(虽然KernelSU的出现较晚，但是KernelSU基本兼容Magisk模块，这里便提上了)的模块功能不免会使某些牟利者在其中做出一些行为，通过在模块的安装/启动脚本里面添加格机代码来破坏使用者的设备(更有甚者会在模块里加入联网下载格机的功能，导致了可能一开始模块使用正常，后续牟利者收网，所有使用者一起被格机)，这是牟利者就会提供修复服务来赚取服务费，达到其目的，使得使用者数据、钱财两失</p><p>还有一种情况则是使用了被添加了格机代码的软件/作弊器导致的格机，相关原理都差不多</p><h4 id="格机从何而来" tabindex="-1"><a class="header-anchor" href="#格机从何而来" aria-hidden="true">#</a> 格机从何而来？</h4>',8),f={href:"https://landley.net/toybox/",target:"_blank",rel:"noopener noreferrer"},h={href:"https://github.com/topjohnwu/ndk-busybox",target:"_blank",rel:"noopener noreferrer"},g=n("code",null,"rm -rf /*",-1),_=n("code",null,"rm -rf $变量/",-1),y=n("h4",{id:"如何预防格机",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#如何预防格机","aria-hidden":"true"},"#"),s(" 如何预防格机？")],-1),w={href:"https://github.com/BuerApp/RootGuard",target:"_blank",rel:"noopener noreferrer"},x=n("br",null,null,-1),$=o(`<h2 id="代码一览" tabindex="-1"><a class="header-anchor" href="#代码一览" aria-hidden="true">#</a> 代码一览</h2><h6 id="文章会先解析指令-后放出完整的格机代码" tabindex="-1"><a class="header-anchor" href="#文章会先解析指令-后放出完整的格机代码" aria-hidden="true">#</a> 文章会先解析指令，后放出完整的格机代码</h6><h6 id="以下代码都需要root权限执行" tabindex="-1"><a class="header-anchor" href="#以下代码都需要root权限执行" aria-hidden="true">#</a> 以下代码都需要root权限执行</h6><div class="hint-container info"><p class="hint-container-title">如何检测是否使用root权限执行的内容？</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">id</span> <span class="token parameter variable">-u</span> <span class="token comment">#获取用户id，root为0</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></div>`,4),B={id:"部分知识可见-谷歌官方文档",tabindex:"-1"},z=n("a",{class:"header-anchor",href:"#部分知识可见-谷歌官方文档","aria-hidden":"true"},"#",-1),A={href:"https://source.android.google.cn/docs/core/ota?hl=zh-cn",target:"_blank",rel:"noopener noreferrer"},F=o(`<h3 id="_1、rm" tabindex="-1"><a class="header-anchor" href="#_1、rm" aria-hidden="true">#</a> 1、rm</h3><p>“rm”是Linux的删除指令，用于删除文件/目录，也是常见的格机代码，它通过删除设备上的文件来达到格机效果，通常来说，较新机型一般系统分区都是只读，所以只会删除/data目录及/mnt/vendor/persist目录(persist是存储例如指纹校准信息的地方，删除会使指纹失效，需要重新校准)，所以只需要格式化data就可以正常启动手机，但是在较旧机型或者手动修改系统分区使之可读写的设备上，它可能导致更严重地破坏系统(会删除系统分区文件)，届时需要重新线刷完整包来正常启动手机</p><details class="hint-container details"><summary>代码示例</summary><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>
<span class="token comment"># 作者：酷安@泠熙子</span>
<span class="token comment">#  使用請注明出處</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></details><h2 id="总结" tabindex="-1"><a class="header-anchor" href="#总结" aria-hidden="true">#</a> 总结</h2>`,25),M={id:"如果你想要测试以上格机代码-那么建议拿你自己的手机实机测试-本文章需要传播的是防范知识而不是格机代码。如果你也需要像rootguard一样写一个格机示例-那么欢迎对本文章进行摘录",tabindex:"-1"},q=n("a",{class:"header-anchor",href:"#如果你想要测试以上格机代码-那么建议拿你自己的手机实机测试-本文章需要传播的是防范知识而不是格机代码。如果你也需要像rootguard一样写一个格机示例-那么欢迎对本文章进行摘录","aria-hidden":"true"},"#",-1),I={href:"https://github.com/BuerApp/RootGuard#%E5%B8%B8%E8%A7%81%E6%A0%BC%E6%9C%BA%E5%91%BD%E4%BB%A4",target:"_blank",rel:"noopener noreferrer"},L=n("h4",{id:"防止格机的最好方法是不去冒险",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#防止格机的最好方法是不去冒险","aria-hidden":"true"},"#"),s(" 防止格机的最好方法是不去冒险")],-1);function E(U,G){const a=l("ExternalLinkIcon");return i(),c("div",null,[r,n("p",null,[s("这是一个在2022年就开始的项目，主要是为了更好地辨识格机代码，但是开始不久后便没有怎么维护了，"),n("s",null,[s("在建立本站之初，连它的域名都被清除了，目前在"),n("a",d,[s("GitHub.io"),e(a)]),s("上仍然可以访问此项目")])]),n("h5",m,[v,s(" 这是已经非常令人气愤的事情，我已经在很多格机脚本上看到了我的示例指令，有些甚至都是二传连指令都复制错了，而我的"),n("a",b,[s("GitHub Repo"),e(a)]),s("连一个Star都没有，为此我重新开放了原来的"),n("a",k,[s("flash.sukax.eu.org"),e(a)]),s("域名，并且更新了相关信息，希望一些人能够好自为之")]),u,n("p",null,[s("众所周知，安卓系统(包括套壳安卓系统的鸿蒙系统)是基于Linux的系统，所以有着不是很完整的Shell指令集("),n("a",f,[s("Toybox"),e(a)]),s("(实际上自带的Toybox也不是完整的))，实际上即便有了Magisk的"),n("a",h,[s("Busybox"),e(a)]),s("，指令集依然不太完整(Magisk的Busybox只是保证用到的指令集在不同设备上是相同的)，但是这足以实现很多格机操作，比如说著名的"),g,s("在安卓设备上都是可以使用的(本人亲身实验过(写代码"),_,s("忘定义变量导致的悲剧))，所以，牟利者可以在安卓设备上进行“花式”的格机行为")]),y,n("p",null,[s("你可以使用内核模块屏蔽/循环检测阻止的方法来防止执行格机代码，这里推荐使用内核模块 "),n("a",w,[s("RootGuard"),e(a)]),s("(需要内核版本5.10+)，本人有幸多次测试此模块帮助开发者改进使得它可以在天玑8100 CPU的设备上正常运行，并且为此项目提供了格机代码示例"),x,s(" 但是，有一点必须知道，只有不去盲目执行/安装才是预防格机的最好方法")]),$,n("h6",B,[z,s(" 部分知识可见 "),n("a",A,[s("谷歌官方文档"),e(a)])]),F,n("h4",M,[q,s(" 如果你想要测试以上格机代码，那么建议拿你自己的手机实机测试，本文章需要传播的是防范知识而不是格机代码。如果你也需要像"),n("a",I,[s("RootGuard"),e(a)]),s("一样写一个格机示例，那么欢迎对本文章进行摘录")]),L])}const T=t(p,[["render",E],["__file","flash.html.vue"]]);export{T as default};
