...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></details><h3 id="_4、cp" tabindex="-1"><a class="header-anchor" href="#_4、cp" aria-hidden="true">#</a> 4、cp</h3><p>“cp”是Linux复制文件/文件夹的指令，可以复制/覆盖路径，覆盖的功能便运用到了格机上面</p><details class="hint-container details"><summary>代码示例</summary><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">cp</span> <span class="token parameter variable">-rf</span> /dev/null /dev/block/bootdevice/by-name/boot <span class="token comment">#替换单槽boot为空</span>
...
<span class="token comment"># 对于分区路径的解释：</span>
<span class="token comment">#  大部分设备的分区路径是 /dev/block/by-name ，部分旧设备是 /dev/block/bootdevice/by-name</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></details><h3 id="_5、重定向操作符" tabindex="-1"><a class="header-anchor" href="#_5、重定向操作符" aria-hidden="true">#</a> 5、重定向操作符</h3><p>重定向操作符(“&gt;&gt;”、“&gt;”)可以让绝大部分指令，例如echo、printf、cat、chmod、chattr等指令都能够进行格机操作(通过将指令的输出内容重定向到指定路径来达到创建/修改文件的效果)</p><details class="hint-container details"><summary>代码示例</summary><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token builtin class-name">echo</span> <span class="token string">&#39;&#39;</span> <span class="token operator">&gt;</span> /dev/block/by-name/cdt <span class="token comment">#修改高通设备参数分区为空</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div></details><h3 id="_7、fastboot" tabindex="-1"><a class="header-anchor" href="#_7、fastboot" aria-hidden="true">#</a> 7、fastboot</h3><p>“fastboot”是可以在设备的BootLoader/FastBoot模式进行刷写的工具，一般用于刷机，但是其清除/格式化功能也可以进行格机</p><details class="hint-container details"><summary>代码示例</summary><div class="language-powershell line-numbers-mode" data-ext="powershell"><pre class="language-powershell"><code>fastboot <span class="token operator">-</span>w <span class="token comment">#清除并格式化存储及缓存分区</span>
